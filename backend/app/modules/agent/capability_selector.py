...
_WRITE_SIGNALS = (
    "保存", "写回", "更新", "修改", "删除", "发布", "创建", "确认后", "save", "apply",
    "persist", "update", "delete", "publish", "create",
)
_ANALYZE_SIGNALS = (
    "分析", "提取", "标签", "关键词", "摘要", "总结", "比较", "结构", "元数据", "优化",
    "analyze", "extract", "tag", "keyword", "summary", "compare", "metadata",
)
_QUERY_SIGNALS = (
    "最近", "最新", "列", "找", "查", "看看", "什么", "文章", "博客", "recent", "latest",
    "list", "show", "find", "query", "post", "article",
)
