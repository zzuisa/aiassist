...
MANIFEST = {
    ...
    "tools": [
        ...
        {
            "key": "content.extract_metadata",
            "source": "internal_api",
            "type": "read",
            "responsibility": "分析文章并提取标签关键词摘要",
            "input_schema": {"type": "object"},
            "risk": {},
            "required_permission": "posts:read",
            "available": True,
        ...
        {
            "key": "posts.apply_analysis",
            "source": "internal_api",
            "type": "write",
            "responsibility": "保存文章分析结果",
            "input_schema": {"type": "object"},
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "给文章生成关键词",
        "总结这几篇博客",
        "extract tags from those posts",
        "analyze the previous articles",
        "suggest keywords",
        "生成文章摘要",
        "比较刚才几篇文章",
        "帮我整理文章元数据",
